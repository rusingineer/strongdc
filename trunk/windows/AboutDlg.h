...
_T("Dìkuji všem, kteøí mì ve vývoji podporovali. THX: Andyman (for startup logo), Blackrabbit, Chmelic, Cinique, Corvik, FarCry, GargoyleMT, Ice, King Wenceslas, Liny, Naga, popKorn, Pothead, ProLogic, Testament, Warrior, xAyiDe a samozøejmì PPK, že mì nechal opsat vìtšinu vìcí z jeho klienta :-)");
...
public:
	...
	LRESULT OnInitDialog(UINT /*uMsg*/, WPARAM /*wParam*/, LPARAM /*lParam*/, BOOL& /*bHandled*/) {
		SetDlgItemText(IDC_VERSION, _T("StrongDC++ v") _T(VERSIONSTRING) _T(STRONGDCVERSIONSTRING) _T(" (c) Copyright 2004-2005 Big Muscle\nBased on: DC++ ") _T(DCVERSIONSTRING) _T(" (c) Copyright 2001-2005 Jacek Sieka\n\nhttp://strongdc.berlios.de"));
