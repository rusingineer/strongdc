...
enum Strings { // @DontAdd
	...
	BAN_USER, // "Ban user(s)"
	BECAUSE_SEGMENT, // " (because of number of segments)"
	BITRATE, // "Bitrate"
	...
	DOWNLOADING_TTHL, // "Downloading TTH tree..."
	DU, // "Down/Up:"
	...
	CHECK_UNVERIFIED_ONLY, // "Don't check TTH on finish when more than 75% of file is verified"
	...
	SETTINGS_FINISHED_DOWNLOAD_DIRTY, // "Set Finished Download tab bold when an entry is added"
	SETTINGS_FINISHED_UPLOAD_DIRTY, // "Set Finished Upload tab bold when an entry is added"
	...
	SETTINGS_TAB_HUB_DIRTY, // "Set hub tab bold when contents change"
	SETTINGS_TAB_PM_DIRTY, // "Set PM tab bold when contents change"
	SETTINGS_TAB_SEARCH_DIRTY, // "Set search tab bold when contents change"
	...
	SHOW_CHUNK_INFO, // "Show chunk info in Transfers"
