...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		PROGRESS_OVERRIDE_COLORS, /*PROGRESS_BUMPED,*/PROGRESS_3DDEPTH, PROGRESS_OVERRIDE_COLORS2,
	...
	POPUP_AWAY, POPUP_MINIMIZED, SHOW_SHARE_CHECKED_USERS, 
	...
	FULL_CHECKED_COLOUR, BAD_CLIENT_COLOUR, BAD_FILELIST_COLOUR, DONT_DL_ALREADY_SHARED, REALTIME_QUEUE_UPDATE,	
 	CONFIRM_HUB_REMOVAL, SUPPRESS_MAIN_CHAT,
	INT_LAST };
