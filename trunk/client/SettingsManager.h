...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		UPLOADQUEUEFRAME_ORDER, UPLOADQUEUEFRAME_WIDTHS, CLIENT_ID, DOWN_SPEED, UP_SPEED,
		MIN_BLOCK_SIZE,	UPDATE_URL, SOUND_TTH, SOUND_EXC,
		STR_LAST };
	...
	SET_MIN4, SET_MAX4, SET_MIN6, SET_MAX6, SET_MIN8, SET_MAXSPEED, FLOOD_CACHE,
	...
	REPORT_ALTERNATES, MEMORY_MAPPED_FILE, CHECK_NEW_USERS,	GARBAGE_COMMAND_INCOMING, GARBAGE_COMMAND_OUTGOING, ENABLE403FEATURES,
	SEARCH_TIME, DONT_BEGIN_SEGMENT, DONT_BEGIN_SEGMENT_SPEED, LOG_SEGMENT, POPUNDER_PM, POPUNDER_FILELIST,
	AUTO_DROP_SOURCE, DISPLAY_CHEATS_IN_MAIN_CHAT,
