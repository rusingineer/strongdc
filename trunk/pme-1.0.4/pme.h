...
class PME
{
  public:
    ...
    /// Returns the regex string for this PME object
    std::string GetRegexString ( ) { return m_sRegexString; }
  ...
  protected:
    ...
    std::string m_sRegexString; ///< Regex string that was compiled
