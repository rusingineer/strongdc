...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		LOG_FORMAT_SYSTEM, LOG_FORMAT_STATUS, LOG_FILE_WEBSERVER, 
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		IPUPDATE, MAX_HASH_SPEED, SEARCH_TTH_ONLY, MAGNET_URI_HANDLER, GET_USER_COUNTRY, CZCHARS_DISABLE,
		...
		CHECK_UNVERIFIED_ONLY, TOGGLE_ACTIVE_WINDOW, 
		INT_LAST };
