...
public:
	...
	enum StrSetting { STR_FIRST,
		...
		UPDATE_URL, SOUND_TTH, SOUND_EXC, SOUND_HUBCON,  SOUND_HUBDISCON, SOUND_FAVUSER,
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		SHOW_PK, SHOW_LOCK, SHOW_SUPPORTS, USE_EMOTICONS, MAX_EMOTICONS, SEND_UNKNOWN_COMMANDS, DISCONNECT,
		IPUPDATE, MAX_HASH_SPEED, SEARCH_ONLY_TTH, MAGNET_URI_HANDLER, GET_USER_COUNTRY, CZCHARS_DISABLE,
		...
		ZONEALARM_DETECTIONS, DETECT_ZONEALARM, ADVANCED_RESUME,
		INT_LAST };
