...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		SEARCH_PASSIVE, SMALL_FILE_SIZE, SHUTDOWN_TIMEOUT, 
		...
		USE_EMOTICONS, SEND_UNKNOWN_COMMANDS, DISCONNECT,
		...
		COLOR_RUNNING, COLOR_DOWNLOADED, COLOR_VERIFIED, AUTO_REFRESH_TIME, USE_SSL, OPEN_WAITING_USERS, 
		BOLD_WAITING_USERS, AUTO_SEARCH_LIMIT,
