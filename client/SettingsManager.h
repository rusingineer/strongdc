...
public:
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		USERLIST_DBLCLICK, TRANSFERLIST_DBLCLICK, CHAT_DBLCLICK, SPEED_USERS, SHOW_CHUNK_INFO, ADC_DEBUG,
		CHECK_UNVERIFIED_ONLY, TOGGLE_ACTIVE_WINDOW, PROGRESSBAR_ODC_STYLE, SEARCH_HISTORY,
		ZONEALARM_DETECTIONS, DETECT_ZONEALARM, ADVANCED_RESUME, ACCEPTED_DISCONNECTS, ACCEPTED_TIMEOUTS,
		...
		NO_IP_OVERRIDE, GROUP_SEARCH_RESULTS,
		INT_LAST };
