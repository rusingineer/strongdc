...
public:
	...
	enum StrSetting { STR_FIRST,
		CONNECTION = STR_FIRST, DESCRIPTION, DOWNLOAD_DIRECTORY, EMAIL, NICK, EXTERNAL_IP,
		...
		UPDATE_URL, SOUND_TTH, SOUND_EXC, SOUND_HUBCON,  SOUND_HUBDISCON, SOUND_FAVUSER, SOUND_TYPING_NOTIFY,
 		BACKGROUND_IMAGE, WEBSERVER_FORMAT, WEBSERVER_USER, WEBSERVER_PASS, LOG_FILE_MAIN_CHAT, 
		...
		EMOTICONS_FILE, SSL_PRIVATE_KEY_FILE, SSL_CERTIFICATE_FILE, SSL_TRUSTED_CERTIFICATES_PATH,
		STR_LAST };
	...
	enum IntSetting { INT_FIRST = STR_LAST + 1,
		...
		COMPRESS_TRANSFERS, SHOW_PROGRESS_BARS, MAX_TAB_ROWS, AUTO_UPDATE_LIST,
		...
		USE_EMOTICONS, MAX_EMOTICONS, SEND_UNKNOWN_COMMANDS, DISCONNECT,
		IPUPDATE, MAX_HASH_SPEED, SEARCH_ONLY_TTH, GET_USER_COUNTRY, CZCHARS_DISABLE,
		DEBUG_COMMANDS, AUTOSAVE_QUEUE, AUTO_PRIORITY_DEFAULT, USE_OLD_SHARING_UI, SHOW_DESCRIPTION_SPEED,
		FAV_SHOW_JOINS, LOG_STATUS_MESSAGES, SHOW_PM_LOG, SHOW_LAST_LINES_LOG, SEARCH_ALTERNATE_COLOUR, SOUNDS_DISABLED,
		...
		AUTO_DROP_SOURCE, DISPLAY_CHEATS_IN_MAIN_CHAT, MAGNET_ASK, MAGNET_ACTION, MAGNET_REGISTER,
		DISCONNECT_RAW, TIMEOUT_RAW, FAKESHARE_RAW, LISTLEN_MISMATCH, FILELIST_TOO_SMALL, FILELIST_UNAVAILABLE,
		ADD_FINISHED_INSTANTLY, AWAY, SETTINGS_USE_CTRL_FOR_LINE_HISTORY, 
		...
		FIREBALL_COLOR, SERVER_COLOR, ACTIVE_COLOR, PASIVE_COLOR, OP_COLOR, 
		...
		USE_VERTICAL_VIEW, SETTINGS_OPEN_NEW_WINDOW, FILE_SLOTS, UDP_PORT, MULTI_CHUNK,
		USERLIST_DBLCLICK, TRANSFERLIST_DBLCLICK, CHAT_DBLCLICK, SPEED_USERS, ADC_DEBUG,
		CHECK_UNVERIFIED_ONLY, TOGGLE_ACTIVE_WINDOW, PROGRESSBAR_ODC_STYLE, SEARCH_HISTORY,
