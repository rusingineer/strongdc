...
_T("Dìkuji všem, kteøí mì ve vývoji podporovali. THX: Andyman (for startup logo), Atom, Blackrabbit, Chmelic, Cinique, Corvik, Crakter, Dreamveawer, FarCry, GargoyleMT, Gigadisk (for Czech translation), Ice, Jove, King Wenceslas, Lee, Legolas, Liny, Mlok, Naga, popKorn, Pothead, ProLogic, Rm., Testament, Warrior, WereWiking, xAyiDe, XiND and ToH for very nice betatesting :-) and to all donators who support me: Kulmegil");
